...
<?php if ($userRegstatus === "registered") : ?>
    ...
    <?php include("includes/queries/recentlyplayedquery.php");   ?>
        ...
        <?php if ($recentSongIds) : ?>
            <div class="entityInfo">
                <div class="leftSection">
                    <img src="https://artist.mwonyaa.com/assets/images/createdplaylist/recentlyplayed.png">
                </div>

                <div class="rightSection">
                    <h2>Recently Played</h2>

                    <p>Find all the Songs you have Most Recently Played Here</p>
