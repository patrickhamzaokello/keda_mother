                ...
                <div class="container">
                    <div class="hero-inner">
                        <div class="hero-copy">
                            ...
                            <div class="hero-cta"><a class="button button-primary" href="register">Create
                                    Account</a><a class="button" href="register">Get in touch</a></div>
                        </div>
            ...
            <section class="cta section">
                <div class="container">
                    <div class="cta-inner section-inner">
                        ...
                        <div class="cta-cta">
                            <a class="button button-primary button-wide-mobile" href="register">Create Account</a>
                        </div>
                    </div>
                </div>
            </section>
