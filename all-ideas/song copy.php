...
<div class="pagesection">
    ...
    <?php if ($song->getTitle() != null) : ?>
            ...
            <div class="songviewartwork">
                ...
                <div class="songplaybuttondiv">
                    <div class="mainplaybutton">
                        ...
                        <a class="icon icon ion-ios-play mainplay" onclick='onwaverplayclick()'></a>
                    </div>
                    <div class="mainpausebutton">
                        <!-- <a class="icon icon ion-ios-pause mainpause" onclick="pauseSong()"></a> -->
                        <a class="icon icon ion-ios-pause mainpause" onclick="onwavepauseclick()"></a>
                    </div>
                </div>
            </div>
        ...
        <div style="margin-bottom: 3em;" id="waveform"></div>
...
<script>
    ...
    var mysongpath = '<?= $song->getPath() ?>';
    wavesurfer.load(mysongpath);


    function onwaverplayclick() {
        wavesurfer.playPause();
    }

    function onwavepauseclick() {
        wavesurfer.pause();
    }
</script>