var currentPlaylist = [];
var shufflePlaylist = [];
var currentPlaylistSongLink = [];
var tempPlaylist = [];
var tempPlaylistSongPath = [];
var audioElement;
var mouseDown = false;
var currentIndex = 0;
var repeat = false;
...
function artistnavitem() {
  ...
  const mobileartistnavitembtn = document.getElementById("mobileartistnavitem");
  const mobilealbumnavitembtn = document.getElementById("mobilealbumnavitem");
  const mobilepodcastnavitembtn = document.getElementById(
    "mobilepodcastnavitem"
  );
  const mobilepoemnavitembtn = document.getElementById("mobilepoemnavitem");
  const mobiledjmixnavitembtn = document.getElementById("mobiledjmixnavitem");
  ...
  mobileartistnavitembtn.classList.add("nav__link--active");
  mobilealbumnavitembtn.classList.remove("nav__link--active");
  mobilepodcastnavitembtn.classList.remove("nav__link--active");
  mobilepoemnavitembtn.classList.remove("nav__link--active");
  mobiledjmixnavitembtn.classList.remove("nav__link--active");
}
...
function albumnavitem() {
  ...
  mobileartistnavitembtn.classList.remove("nav__link--active");
  mobilealbumnavitembtn.classList.add("nav__link--active");
  mobilepodcastnavitembtn.classList.remove("nav__link--active");
  mobilepoemnavitembtn.classList.remove("nav__link--active");
  mobiledjmixnavitembtn.classList.remove("nav__link--active");
}
...
function podcastnavitem() {
  ...
  mobileartistnavitembtn.classList.remove("nav__link--active");
  mobilealbumnavitembtn.classList.remove("nav__link--active");
  mobilepodcastnavitembtn.classList.add("nav__link--active");
  mobilepoemnavitembtn.classList.remove("nav__link--active");
  mobiledjmixnavitembtn.classList.remove("nav__link--active");
}
function poemnavitem() {
  ...
  mobilealbumnavitembtn.classList.remove("nav__link--active");
  mobilepodcastnavitembtn.classList.remove("nav__link--active");
  mobilepoemnavitembtn.classList.add("nav__link--active");
  mobiledjmixnavitembtn.classList.remove("nav__link--active");
}
function djmixnavitem() {
  ...
  mobilepodcastnavitembtn.classList.remove("nav__link--active");
  mobilepoemnavitembtn.classList.remove("nav__link--active");
  mobiledjmixnavitembtn.classList.add("nav__link--active");
}
...
function downloadAlbumSongsCache() {
...
async function downloadalbumall() {
  ...
  const result = await downloadAlbumSongsCache();
  console.log(result);
}
